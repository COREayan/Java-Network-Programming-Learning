        ...
        if (smtpSocket != null && out != null && in != null) {
            try {
                ...
                */
                ...
                /*
                    STEP 2 The client inititates its dialog by responding with a HELLO command identifying itself.
                */
...
//                out.println("MAIL From : " + fromto);
                ...
                */
                out.println("RCPT TO: jnetworkprograming@gmail.com");
                ...
                */
                ...
                while ((responseLine = in.readLine()) != null) {
                    System.out.println("Server: " + responseLine);
                    if (responseLine.indexOf("354") != -1) break; 
                }
